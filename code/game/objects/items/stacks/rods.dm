GLOBAL_LIST_INIT(rod_recipes, list ( \
	...
	new/datum/stack_recipe("catwalk", /obj/item/stack/catwalk, 1, 2, 20), \
	new/datum/stack_recipe("plated catwalk", /obj/item/stack/catwalk/plated, 1, 2, 20), \
	new/datum/stack_recipe("dark plated catwalk", /obj/item/stack/catwalk/plated/dark, 1, 2, 20), \
	new/datum/stack_recipe("smooth plated catwalk", /obj/item/stack/catwalk/plated/smooth, 1, 2, 20), \
	))
